<template>
  <v-app dark>
    ...
    >
      <v-list>
        <v-card v-if="!auth"> Please Login to View Content </v-card>
        ...
        <v-divider></v-divider>
        <v-card hover v-if="auth">
          <router-link to="/planets" style="text-decoration: none"
            >Planets</router-link
          >
        </v-card>
        <v-divider></v-divider>
        <v-card hover v-if="auth">
          <router-link to="/species" style="text-decoration: none"
            >Species</router-link
          >
        </v-card>
        <v-divider></v-divider>
        <v-card hover v-if="auth">
          <router-link to="/starships" style="text-decoration: none"
...
export default {
  ...
  data() {
    return {
      ...
      right: true,
      rightDrawer: false,
      title: "Star Wars Guide (Made with Vuetify and Swapi.dev API)",
      filterText: "",
    };
  },
  components: {
